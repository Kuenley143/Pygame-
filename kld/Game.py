...
#load images 
bg = pygame.image.load('image/4dof85iq.png').convert_alpha()
#castle
castle_img_100 = pygame.image.load('image/castle.png').convert_alpha()
...
for enemy in enemy_types:
    ...
    for i in range(num_of_frames):
        img = pygame.image.load(f'image/enemies/{enemy}/{animation}/{i}.png').convert_alpha()
        e_w = img.get_width()
        e_h = img.get_height()
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, image, x, y, angle):
        ...
        self.speed = 10
        #calculate the horizontal and vertical speeds baed on the angle
...
#create castle
castle = castle(castle_img_100, SCREEN_WIDTH - 150, SCREEN_HEIGHT - 200, 0.2)
...
#ccreate enemies
enemy_1 = Enemy(enemy_health[0], enemy_animations[0], 200, SCREEN_WIDTH - 100, 1)
